...
#define _TREE_CMP(t_ptr, l, r) ((t_ptr)->_cmp ? (t_ptr)->_cmp((l), (r)) : (l) < (r))
#define _TREE_LSS(t_ptr, l, r) ((t_ptr)->_cmp ? (t_ptr)->_cmp((l), (r)) < 0 : (l) < (r))
#define _TREE_EQU(t_ptr, l, r) ((t_ptr)->_cmp ? (t_ptr)->_cmp((l), (r)) == 0 : (l) == (r))
#define _TREE_LEQ(t_ptr, l, r) ((t_ptr)->_cmp ? (t_ptr)->_cmp((l), (r)) <= 0 : (l) <= (r))

#define _TN_IS_RED(tn) ((tn) ? (tn)->_red : 0)

#define _TI_FROM_TN(K_T, V_T, t, tn) ((tree_it(K_T, V_T)){ \
    ._t = (t),                                             \
    ._node = (tn),                                         \
...
typedef struct _tree_it(K_T, V_T) {                                                              \
    ...
    CAT2(tree_it(K_T, V_T), _prev_t)                                                             \
        _prev;                                                                                   \
                                                                                                 ...
                                                                                                 \
typedef void(*CAT2(tree(K_T, V_T), _free_t))                                                     \
    (struct _tree(K_T, V_T)*);                                                                   \
...
typedef int(*CAT2(tree(K_T, V_T), _delete_t))                                                    \
    (struct _tree(K_T, V_T)*, K_T);                                                              \
...
typedef tree_it(K_T, V_T)(*CAT2(tree(K_T, V_T), _gtr_t))                                         \
    (struct _tree(K_T, V_T)*, K_T);                                                              \
typedef int(*CAT2(tree(K_T, V_T), _cmp_t))                                                       \
    (K_T, K_T);                                                                                  \
                                                                                                 \
typedef struct _tree(K_T, V_T) {                                                                 \
    ...
    CAT2(tree(K_T, V_T), _cmp_t) const _cmp;                                                     \
                                                                                                 ...
                                                                                                 \
/* tree node */                                                                                  \
tree_node(K_T, V_T) CAT2(tree_node(K_T, V_T), _make)(K_T key, V_T val) {                         \
    tree_node(K_T, V_T) node =                                                                   \
        (tree_node(K_T, V_T))malloc(                                                             \
            sizeof(struct _tree_node(K_T, V_T)));                                                \
                                                                                                 \
    node->_red  = 1;                                                                             \
    ...
    return node;                                                                                 \
                                                                                                 ...
                                                                                                 \
void CAT2(tree_node(K_T, V_T), _free)(tree_node(K_T, V_T) node) {                                \
    if (node) {                                                                                  \
        ...
        free(node);                                                                              \
                                                                                                 ...
                                                                                                 \
tree_node(K_T, V_T) CAT2(tree_node(K_T, V_T), _rotate)(tree_node(K_T, V_T) node, int dir) {      \
    ...
    return result;                                                                               \
                                                                                                 ...
                                                                                                 \
tree_node(K_T, V_T) CAT2(tree_node(K_T, V_T), _rotate2)(tree_node(K_T, V_T) node, int dir) {     \
    tree_node(K_T, V_T) result = NULL;                                                           \
    if (node) {                                                                                  \
        node->_children[!dir] = CAT2(tree_node(K_T, V_T), _rotate)(node->_children[!dir], !dir); \
        if (node->_children[!dir])                                                               \
            node->_children[!dir]->_parent = node;                                               \
    ...
    return result;                                                                               \
                                                                                                 ...
                                                                                                 \
/* tree it */                                                                                    \
void CAT2(tree_it(K_T, V_T), _next)(struct _tree_it(K_T, V_T) * it) {                            \
    ...
    it->_node = node;                                                                            \
                                                                                                 ...
                                                                                                 \
void CAT2(tree_it(K_T, V_T), _prev)(struct _tree_it(K_T, V_T) * it) {                            \
    tree_node(K_T, V_T) node = it->_node;                                                        \
                                                                                                 \
...
tree_it(K_T, V_T) CAT2(tree(K_T, V_T), _insert)(tree(K_T, V_T) t, K_T key, V_T val) {            \
    ...
    if (!t->_root) {                                                                             \
        ...
        for (;;) {                                                                               \
            if (q == NULL) {                                                                     \
                ...
                p->_children[dir] = q = CAT2(tree_node(K_T, V_T), _make)(key, val);              \
                q->_parent = p;                                                                  \
                made_new = 1;                                                                    \
            } else if (_TN_IS_RED(q->_children[0]) && _TN_IS_RED(q->_children[1])) {             \
            ...
            if (_TN_IS_RED(q) && _TN_IS_RED(p)) {                                                \
                ...
                if (q == p->_children[last]) {                                                   \
                    h->_children[dir2] = CAT2(tree_node(K_T, V_T), _rotate)(g, !last);           \
                } else {                                                                         \
                    h->_children[dir2] = CAT2(tree_node(K_T, V_T), _rotate2)(g, !last);          \
                }                                                                                \
                                                                                                 \
                if (h->_children[dir2])                                                          \
    ...
    return _TI_FROM_TN(K_T, V_T, t, node);                                                       \
                                                                                                 ...
                                                                                                 \
int CAT2(tree(K_T, V_T), _delete)(tree(K_T, V_T) t, K_T key) {                                   \
    if (t->_root == NULL)                                                                        \
        return 0;                                                                                \
                                                                                                 \
    ...
    while (q->_children[dir] != NULL) {                                                          \
        ...
        if (!_TN_IS_RED(q) && !_TN_IS_RED(q->_children[dir])) {                                  \
            if (_TN_IS_RED(q->_children[!dir])) {                                                \
                p->_children[last] = CAT2(tree_node(K_T, V_T), _rotate)(q, dir);                 \
                if (p->_children[last])                                                          \
                ...
                if (s) {                                                                         \
                    if (!_TN_IS_RED(s->_children[!last]) && !_TN_IS_RED(s->_children[last])) {   \
                                                                                                 \
                        /* Color flip */                                                         \
                        p->_red = 0;                                                             \
                        s->_red = 1;                                                             \
                        ...
                        if (_TN_IS_RED(s->_children[last])) {                                    \
                            g->_children[dir2] = CAT2(tree_node(K_T, V_T), _rotate2)(p, last);   \
                        } else if (_TN_IS_RED(s->_children[!last])) {                            \
                            g->_children[dir2] = CAT2(tree_node(K_T, V_T), _rotate)(p, last);    \
                        }                                                                        \
                        if (g->_children[dir2])                                                  \
    ...
    if (f) {                                                                                     \
        ...
        q->_val = tmp_v;                                                                         \
                                                                                                 \
        p->_children[p->_children[1] == q] = q->_children[q->_children[0] == NULL];              \
    ...
    return 1;                                                                                    \
                                                                                                 ...
                                                                                                 \
tree_it(K_T, V_T) CAT2(tree(K_T, V_T), _lookup)(tree(K_T, V_T) t, K_T key) {                     \
...
tree_it(K_T, V_T) CAT2(tree(K_T, V_T), _last)(tree(K_T, V_T) t) {                                \
    ...
    return _TI_FROM_TN(K_T, V_T, t, node);                                                       \
                                                                                                 ...
                                                                                                 \
void CAT2(tree(K_T, V_T), _free)(tree(K_T, V_T) t) {                                             \
    if (t->_root)                                                                                \
        CAT2(tree_node(K_T, V_T), _free)(t->_root);                                              \
    free(t);                                                                                     \
}                                                                                                \
                                                                                                 \
tree_it(K_T, V_T) CAT2(tree(K_T, V_T), _geq)(tree(K_T, V_T) t, K_T key) {                        \
    tree_node(K_T, V_T) last = NULL,                                                             \
                        node = t->_root;                                                         \
                                                                                                 \
    while (node) {                                                                               \
    ...
    return _TI_FROM_TN(K_T, V_T, t, last);                                                       \
                                                                                                 ...
                                                                                                 \
tree_it(K_T, V_T) CAT2(tree(K_T, V_T), _gtr)(tree(K_T, V_T) t, K_T key) {                        \
    tree_node(K_T, V_T) last = NULL,                                                             \
                        node = t->_root;                                                         \
                                                                                                 \
    while (node) {                                                                               \
    ...
    return _TI_FROM_TN(K_T, V_T, t, last);                                                       \
                                                                                                 ...
                                                                                                 \
tree(K_T, V_T) CAT2(tree(K_T, V_T), _make)(void * cmp) {                                         \
    tree(K_T, V_T) t =                                                                           \
        (tree(K_T, V_T))malloc(                                                                  \
